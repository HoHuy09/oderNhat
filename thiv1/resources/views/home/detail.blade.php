          ...
          <div x-data="{ open: false }" @mouseleave="open = false" class="relative">
            ...
            <div x-show="open" x-transition.scale.origin.right class="absolute bg-whitew-72 w-64 right-0 px-3 py-5  mt-2 bg-white shadow-xl">
              ...
              <div class="mt-3 border-t-2 border-gray-300 ">
                 <a href="{{route('cart',['userid' => $user[0]['id']])}}"><button class="border-2 border-yellow-500 mt-3 hover:bg-yellow-500 hover:text-white text-center w-full text-yellow-500">view cart</button></a>
              </div>
            </div>
          </div>
          <!-- end giỏ hàng -->
