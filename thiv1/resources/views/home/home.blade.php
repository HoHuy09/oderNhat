...
<html lang="en">
  ...
  <body>
      ...
      <div class="containers py-4">
        <div class="grid grid-cols-12 gap-10">
          ...
          <div class="col-span-3 lg:ml-auto flex gap-10 mt-1">
            <div
              class="text-2xl text-white relative hidden lg:block"
              x-data="{ open: false }"
            ...
            >
              ...
              <div
                x-show="open"
                x-transition.scale.origin.right
                class="absolute bg-whitew-72 right-0 py-24 mt-2 bg-white shadow-xl"
              >
    ...
    <div class="containers">
      <div class="grid lg:grid-cols-12 border-t border-gray-300 border-b">
        ...
        <div class="relative block lg:hidden">
          <div class="absolute flex w-full mt-5 px-5 md:px-16">
            <div class="flex">
              ...
              <img class="h-7 ml-3" src="{{asset('storage/anhweb/logo 2c.png')}}" alt="" />
            </div>
            <div class="ml-auto">
              <i class="fab fa-opencart text-xl text-white"></i>
            </div>
          </div>
          <div class="absolute w-full mt-14 px-5 md:px-16">
            <div class="relative">
              <input
                type="text"
                class="w-full p-1 mt-1 pr-20 py-2 px-2 rounded-md"
                placeholder="Nhập tên sản phẩm ..."
              />
              <i class="fas fa-search absolute top-4 right-4"></i>
            </div>
          </div>
          <img src="{{asset('storage/anhweb/bannermobile.png')}}" alt="" />
        </div>
      </div>
    </div>
    <!-- end danh sach -->
    ...
    <div class="containers border-t-4 border-gray-300 block lg:hidden px-5 md:px-16">
      <div>
        ...
        <div class="grid grid-cols-4 md:grid-cols-8 mt-5 gap-5">
          <div class="text-center">
            <a href="">
              <img class="mx-auto w-7/12 md:w-10/12" src="./image/amazon2.png" alt="" />
              <span class="text-sm">Amazon</span>
            </a>
          </div>
          <div class="text-center">
            <a href="">
              <img class="mx-auto w-7/12 md:w-10/12" src="./image/shop.png" alt="" />
    ...
    <div class="containers px-5 md:px-16 lg:px-0 mt-10">
      <div class="flex">
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5 mt-8"
      >
    ...
    <div class="containers px-5 md:px-16 lg:px-0 mt-10">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5 mt-8">
    ...
    <!-- danh mục -->
    <div class="containers px-5 md:px-16 lg:px-0 mt-20">
      <div class="">
        <div class="flex">
      ...
      <div class="grid grid-cols-2 md:grid-cols-6 mt-10 text-center gap-5">
